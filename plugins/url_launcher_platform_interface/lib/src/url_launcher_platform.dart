...
abstract class UrlLauncherPlatform extends PlatformInterface {
  ...
  Future<void> preLaunchUrl() {
    throw UnimplementedError('preLaunchUrl() has not been implemented.');
  }

  ///web 实现，关闭预加载窗口
  Future<void> closePreLaunchUrl() {
    throw UnimplementedError('closePreLaunchUrl() has not been implemented.');
  }
