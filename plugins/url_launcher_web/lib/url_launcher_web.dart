...
class UrlLauncherPlugin extends UrlLauncherPlatform {
  ...
  bool openNewWindow(String url, {String? webOnlyWindowName}) {
    ...
    if (_newTabWindow != null) {
      _newTabWindow!.postMessage(url.toJS,"*".toJS);
      _newTabWindow = null;
    } else {
  ...
  @override
  Future<void> preLaunchUrl() {
    _newTabWindow =
        _window.open("/assets/packages/url_launcher_web/assets/loading.html?t=${DateTime.now().millisecondsSinceEpoch}", "_blank");
    return Future<bool>.value(true);
  }

  @override
  Future<void> closePreLaunchUrl() async{
    _newTabWindow?.close();
    _newTabWindow = null;
  }
